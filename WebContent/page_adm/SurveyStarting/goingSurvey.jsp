...
%>
      ...
      <section class="page-section">
         ...
         <%}else{ %>
         <form action="/PeerSys/deleteIng.sv" method="POST">
         ...
         <td>
         <input type="hidden" name="surIngIndex" value="<%=surGoingList.get(i).getIngSeq() %>">
         <input type="submit" class="btn btn-mod btn-border-w btn-medium btn-round" value="삭제하기" >
         </td>
         </tr>
         <%} %>
         </tbody>
