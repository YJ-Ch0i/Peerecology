			...
			<div class="container relative">
				...
				<div class="row">
					...
					<% SchoolService schoolService = SchoolService.getInstance(); 
                               ArrayList<SchoolDTO> list = schoolService.school_List();
                            %>
					...
					<div class="col-sm-3 mb-40">
						...
						<button
							onclick="location.href='selectClass.jsp?sch_code=<%=list.get(i).getSch_code()%>&sch_name=<%=list.get(i).getSch_name() %>'"
							class="btn btn-mod btn-circle btn-medium"
							style="width: 100%; margin-bottom: 20px;">
							<h5><%= list.get(i).getSch_name() %></h5>
						</button>
