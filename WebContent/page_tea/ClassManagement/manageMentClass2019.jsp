		...
		<section class="page-section">
			<div class="container relative">
				...
				<%                    
				   ...
				   TeacherDTO teacher = teaService.teacherInfo2019(tea_id);
                   ...
                   %>
				 <div class="row">
				 	<h3 class="hs-line-11 font-alt mb-20 mb-xs-0">학급 학생 관리 (<%=school.getName()%> <%= teacher.getGrade()%>학년 <%=teacher.getClasses()%>반)</h3>
				 	<div class="col-md-2">
				 		<a href="manageMentClass.jsp" class="btn btn-mod btn-circle btn-medium">2020년 학급 보기</a>
				 	</div>
